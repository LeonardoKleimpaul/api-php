...
class UsuariosService
{
    ...
    {
        [$nome, $email, $status] = [$this->dadosCorpoRequest['nome'], $this->dadosCorpoRequest['email'], $this->dadosCorpoRequest['status']];

        if ($nome && $email) {
            if($this->usuariosRepository->insertUser($nome, $email, $status) > 0) {
